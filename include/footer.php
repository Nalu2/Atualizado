<footer>
    ...
    <div class="row">
        ...
        <div class="col-sm" id="texto">
            ...
            <img src="interrogatorio.png" id="icone_interrogacao" alt="">
                <div class="perguntas">
        ...
        <!-- 3ª Coluna -->
        <div class="col-sm">
            <p><img src="facebook.png" id="icone" alt=""><label class="icone">Facebook</label></p>
            <p><img src="instagram.png" id="icone" alt=""><label class="icone">Instagram</label></p>
            <p><img src="youtube.png" id="icone" alt=""><label class="icone">Youtube</label></p>
            <p><img src="twitter-alt-circle.png" id="icone" alt=""><label class="icone"><Tr></Tr>witter</label></p>
        </div>
        <div class="row">
